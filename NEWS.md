...
- Rewritten examples in README to better show the role of the background data.

## Bug fixes

- When `bg_X` contained more columns than `X`, some prediction functions could fail when being applied to `bg_X`. 
